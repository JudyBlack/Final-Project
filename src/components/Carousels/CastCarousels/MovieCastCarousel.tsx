...
export const MovieCastCarousel = () => {
  ...
  return (
    <div>
      <Carousel draggable slidesToShow={4} slidesToScroll={4}  style={{width:700, height: 350 , color: 'white' , boxSizing: "border-box" }} >
        {cast.map((actor) => (
          <li key={actor.id}>
            <div  className="actor_container" style={{width: 120, }}>
            <img src={actor.profile_path? API_IMG + actor.profile_path: "path/to/default/image" }
