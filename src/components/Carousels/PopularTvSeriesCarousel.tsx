...
const PopularTVSeriesCarousel: React.FC = () => {
  const [tvSeries, setTVSeries] = useState<TVSeries[]>([]);

  useEffect(() => {
    const apiUrl = `https://api.themoviedb.org/3/tv/popular?api_key=bcc17120a385c08820f57a74b97eef53&language=en-US&page=1`;
...
export default PopularTVSeriesCarousel;
